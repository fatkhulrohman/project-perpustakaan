<!doctype html>
    <html>
        ...
        <body>
            <img src="<?php echo base_url('assets/img/head.jpg');?>" height="180px" width="100%">
            <!-- Static navbar -->
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8 ">
                        <legend>Selamat Datang di Apliasi Perpusatakaan SMKN 03 Kabupaten Tangerang</legend>
						<img src="<?php echo base_url('assets/img/layar.jpg');?>" height="350px" width="100%">
                    </div>
                </div>
            </div>
